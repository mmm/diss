...
As a first step, the Hadamaard transformation acts on a quantum 
register, preparing it in a superposition of all possible values 
of $x$.

A Hadamaard transformation acting on a general state $\ket{x}=\ket{x_1\ldots x_N}$
