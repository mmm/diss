...
All that's really needed from this is the period of the function
...
calculate this with a quantum circuit\cite{Coppersmith:94}
...
Grover's algorithm manages to get to this probability of success
in about the order of $\sqrt{N}$ evaluations.
