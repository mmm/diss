...
by using the Hadamaard transformation
\begin{equation}
...
\end{equation}
At this point, a measurement of this first register tells
nothing about $a$, but taking another Hadamaard transformation on
the first register gives
\begin{equation}
...
\end{equation}
Notice that this is non--zero only for $a\cdot y=0$.  The first register
