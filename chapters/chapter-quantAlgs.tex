...
In step (\ref{fig:grover:diffusion}) of Grover's algorithm
...
The desired state should be measured with probability of at
least $\frac{1}{2}$.
A careful analysis of these two important aspects of the 
